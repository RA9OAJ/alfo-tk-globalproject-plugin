...
wp_register_style('tkgt-taks-css', TKGT_STYLES_URL . 'default/css/page.css', array());
wp_register_script('tkgt-tasks-js', TKGT_STYLES_URL . 'default/js/page.js', array('jquery'));
